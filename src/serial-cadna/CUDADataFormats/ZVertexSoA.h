...
struct ZVertexSoA {
  ...
  float_st zv[MAXVTX];          // output z-posistion of found vertices
  float_st wv[MAXVTX];          // output weight (1/error^2) on the above
  float_st chi2[MAXVTX];        // vertices chi2
  float_st ptv2[MAXVTX];        // vertices pt^2
