...
else ifeq ($(KOKKOS_CUDA_ARCH),72)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_VOLTA72=On
...
else ifeq ($(KOKKOS_CUDA_ARCH),87)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_AMPERE87=On
else ifeq ($(KOKKOS_CUDA_ARCH),89)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_ADA89=On
else ifeq ($(KOKKOS_CUDA_ARCH),90)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_HOPPER90=On
else ifeq ($(KOKKOS_CUDA_ARCH),100)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_BLACKWELL100=On
else ifeq ($(KOKKOS_CUDA_ARCH),103)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_BLACKWELL103=On
else ifeq ($(KOKKOS_CUDA_ARCH),120)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_BLACKWELL120=On
else ifeq ($(KOKKOS_CUDA_ARCH),121)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_BLACKWELL121=On
else ifeq ($(KOKKOS_CUDA_ARCH),107)
  KOKKOS_CMAKE_CUDA_ARCH := -DKokkos_ARCH_RUBIN107=On
else
